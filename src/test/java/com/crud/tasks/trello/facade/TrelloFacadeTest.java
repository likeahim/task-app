...
public class TrelloFacadeTest {
    ...
    void shouldFetchTrelloCard() {
        ...
        TrelloCardDto trelloCardDto = new TrelloCardDto(
                "name_test", "name_desc", "name_pos", "listId_test"
        );
        when(trelloService.createdTrelloCard(trelloCardDto)).thenReturn(
                new CreatedTrelloCardDto("1234", "false_name", "www.false.com")
        );

        //When
        CreatedTrelloCardDto returnedTrelloCardDto = trelloService.createdTrelloCard(trelloCardDto);

        //Then
        assertNotEquals("name_test", returnedTrelloCardDto.getName());
        assertEquals("1234", returnedTrelloCardDto.getId());
    }
}
